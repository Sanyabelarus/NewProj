...
public class Main {
  ...
  @Autowired private TrainingTypesRepository trainingTypesRepository;
  @Autowired private TrainerRepository trainerRepository;
  @Autowired private Timeepository timeepository;
  ...
  public TrainingTypesRepository getTrainingTypesRepository() {
    return trainingTypesRepository;
  }
  ...
  public static void createClient(Main main, User user) {
    Client client = new Client();
    client.setUser(user);
    client.setMoney(100);
    client.setHaveclubcard(false);
    main.getClientRepository().save(client);
  }
}
